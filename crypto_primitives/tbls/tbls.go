...
func DeriveRootPubKey(verificationVectors ...[]string) string {
	...
	*/
	...
	// Now iterate over verification vectors with indexes 1,2,... and aggregate with pubkeys with appropriate indexes (futureRootPubKey[1],futureRootPubKey[2],...)
...
// These signatures by T parties will be aggregated later and can be verified with rootPubKey(pubkey of group)
